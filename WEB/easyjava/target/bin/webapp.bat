...
set CLASSPATH="%BASEDIR%"\etc;"%REPO%"\org\apache\tomcat\embed\tomcat-embed-core\8.5.38\tomcat-embed-core-8.5.38.jar;"%REPO%"\org\apache\tomcat\tomcat-annotations-api\8.5.38\tomcat-annotations-api-8.5.38.jar;"%REPO%"\mysql\mysql-connector-java\5.1.48\mysql-connector-java-5.1.48.jar;"%REPO%"\org\aspectj\aspectjweaver\1.9.2\aspectjweaver-1.9.2.jar;"%REPO%"\pro\wendell\easyunser\simple-embedded-tomcat-webapp\1.0-SNAPSHOT\simple-embedded-tomcat-webapp-1.0-SNAPSHOT.jar
